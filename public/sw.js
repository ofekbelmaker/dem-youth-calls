...
/* ⚠️ להעלות את המספר בכל שינוי שחייב להגיע למכשירים שכבר פתחו את
   האפליקציה. הניקוי ב-activate מוחק רק מטמונים ששמם שונה מהנוכחי,
   כך שכל עוד השם לא מתחלף הישן נשאר — וטלפן עם האפליקציה במסך
   הבית ימשיך לראות את הגרסה שהייתה כשהתקין אותה. */
const CACHE = "dyc-v2";
